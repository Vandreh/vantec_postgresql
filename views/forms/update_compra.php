...
<form action="<?=$GLOBALS['project_index'];?>/controllers/add_compras.php" method="POST">
	...
	<div class="row">	
		...
		<div class="col-md-4">
			...
			<input type="number" name="precio_compra" placeholder="Digite el descuento"  class="form-control" value="<?=$compra_r['precio_compra'];?>">
			<br><br>
		</div>
		
		<div class="col-md-4">
			<label> Flete: </label><br>
			<input type="number" name="flete" placeholder="Digite el descuento"  class="form-control" value="<?=$compra_r['flete'];?>">
			<br><br>
		</div>
		
		<div class="col-md-4">
			<label> Impuesto: </label><br>
			<input type="number" name="impuesto" placeholder="Digite el descuento"  class="form-control" value="<?=$compra_r['impuesto'];?>">
			<br><br>
		</div>

<?php  
	...
	switch($_POST['action']){
		...
		case 'add':
			$manager = new Manager;
			unset($_POST['action']);
			$manager->insert_common("tb_clientes", $_POST, null);
		break;

		case 'edit':
			$manager = new Manager;
			unset($_POST['action']);
			$manager->update_common("tb_clientes", $_POST, ['id_cliente'=>$_POST['id_cliente']],null);
		break;

		case 'delete':
			$manager = new Manager;
			unset($_POST['action']);
			$manager->delete_common("tb_clientes",['id_cliente'=>$_GET['id']],null);
		break;
	}

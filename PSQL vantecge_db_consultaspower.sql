...
CREATE TABLE public.estoque (
  ...
  estoque_created_in timestamp NOT NULL DEFAULT current_timestamp,
  user_cpf varchar(30) NOT NULL
);



CREATE TABLE public.ingresos_usuario (
...
CREATE TABLE tb_clientes (
  ...
  cliente_phone varchar(25) DEFAULT NULL,
  cliente_cellphone varchar(25) DEFAULT NULL,
  cliente_address varchar(255) DEFAULT NULL,
  cliente_birth date DEFAULT NULL,
  tipo_piel varchar(25) DEFAULT NULL,
  favorito varchar(25) DEFAULT NULL,
...
CREATE TABLE public.tb_clientes1 (
  id_cliente SERIAL PRIMARY KEY,
  texto_json text NOT NULL,
...
CREATE TABLE public.tb_compras (
  ...
  descuento_compra int DEFAULT NULL,
...
CREATE TABLE public.tb_compras1 (
  id_compra SERIAL PRIMARY KEY,
...
CREATE TABLE public.tb_productos (
  ...
  user_cpf varchar(30) NOT NULL,
  "status" varchar(30) DEFAULT 'Activado'
);


INSERT INTO public.tb_productos (id_producto, product_name, tipo_producto, product_price, codigo, puntos, producto_created_in, user_cpf, "status") VALUES
...
CREATE TABLE public.tb_productos1 (
  id_producto SERIAL PRIMARY KEY,
  texto_json text NOT NULL,
...
CREATE TABLE tb_users (
  ...
  user_cpf varchar UNIQUE NOT NULL,
  user_phone varchar DEFAULT NULL,
  user_cellphone varchar DEFAULT NULL,
  user_address varchar DEFAULT NULL,
  user_created_in timestamp NULL DEFAULT current_timestamp,
  profile_id int DEFAULT NULL,
  user_full_name varchar NOT NULL,
  user_status varchar(30) DEFAULT 'Activado',
...
CREATE TABLE tb_ventas (
  ...
  producto_venta varchar NOT NULL,
  codigo varchar NOT NULL,
  lote varchar NOT NULL,
  descuento_venta decimal(11,2) NOT NULL,
  delivery decimal(11,2) NOT NULL,
